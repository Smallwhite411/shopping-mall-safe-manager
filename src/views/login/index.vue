...
const testTreeToArray = reactive([
...
// console.log(treeToArray(testTreeToArray))

const testArrayToTree = reactive([
  {
    id: 0,
    name: 'root',
    parentId: null,
...
const ddd = toRaw(arrayToTree(testArrayToTree))
